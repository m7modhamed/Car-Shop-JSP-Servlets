    ...
    <form action="AddTruck" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="payloadCapacity" class="form-control" id="payloadCapacity" required>
            </div>

            <div class="col-md-4">
                <label for="bedLength" class="form-label">Bed Length</label>
                <input type="number" name="bedLength" class="form-control" id="bedLength" required>
            </div>
